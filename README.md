...
Tekoäly auttoi pääsemään tehokkaaseen alkuun. Figman sisäinen Figma Make oli hyvä alku projektille mikä näytti kurssin ohjeiden lisäki myös minkälainen rakenne sivulla on hyvä olla. Tämä mahdollisti sen että projektin alkuvaiheessa ei ollut ylimääräistä ajattelua ja testailua ja ylipäätäänsä ylimääräistä säätö.
...
Philip Hermunen
Loin figmaan kokonaan moodboardin, styleguidin sekä alkuperäisen desktop designin sivulle, kokonaan tehty autolayoutilla sekä jaettu valmiiksi sectioneihin jotka olivat helppo myöhemmin jakaa kaikille totetutettavaksi. Olin mukana suunnittlemassa sivuston koodin rakenteen mutta sen toteutus oli enemmän Nooan brillianssia. Tekemiset section on minun tekemä. Kaikki kuvat ja grafiikat, lukuunottamatta sivulla viimeinen katse ylös kehotus. olivat minun ottamia ja editoituja sekä kampanjavideo on minun tekemä. 
...
Tämän lisäksi jos ajattelee HSL:llän designia ja miksi se on sen näköinen mikä on päätyy nopeasti siihen että se on suunniteltu olemaan helppo ymmärtää ja accessible. Sivun UI on hyvin selkeä, sivulla ei ole mitään mitä käyttäjä voi olla huomaamatta, ja toiminnallisuudet on helppoja ymmärtää. 